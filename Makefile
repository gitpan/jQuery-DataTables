# This Makefile is for the jQuery::DataTables extension to perl.
#
...
#     ABSTRACT => q[Server-side part of DataTables]
#     AUTHOR => [q[Konstantin Tokar (konstantin@tokar.ru)]]
#     BUILD_REQUIRES => {  }
#     NAME => q[jQuery::DataTables]
#     PREREQ_PM => { Test::Simple=>q[0.44] }
#     VERSION_FROM => q[lib/jQuery/DataTables.pm]
...
FULLEXT = jQuery\DataTables
BASEEXT = DataTables
PARENT_NAME = jQuery
DLBASE = $(BASEEXT)
VERSION_FROM = lib/jQuery/DataTables.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/jQuery/DataTables.pm

# Where is the Config information that we are using/depend on
CONFIGDEP = $(PERL_ARCHLIB)$(DFSEP)Config.pm $(PERL_INC)$(DFSEP)config.h

# Where to build things
INST_LIBDIR      = $(INST_LIB)\jQuery
INST_ARCHLIBDIR  = $(INST_ARCHLIB)\jQuery
...
TO_INST_PM = lib/jQuery/DataTables.pm

PM_TO_BLIB = lib/jQuery/DataTables.pm \
...
DISTNAME = jQuery-DataTables
DISTVNAME = jQuery-DataTables-1.0
...
DataTables.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"jQuery::DataTables\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/jQuery/DataTables.pm $(INST_MAN3DIR)\jQuery.DataTables.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) "name:               jQuery-DataTables" >> META_new.yml
	$(NOECHO) $(ECHO) "version:            1.0" >> META_new.yml
	$(NOECHO) $(ECHO) "abstract:           Server-side part of DataTables" >> META_new.yml
	$(NOECHO) $(ECHO) "author:" >> META_new.yml
	$(NOECHO) $(ECHO) "    - Konstantin Tokar (konstantin@tokar.ru)" >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) "    <ABSTRACT>Server-side part of DataTables</ABSTRACT>" >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) "    <AUTHOR>Konstantin Tokar (konstantin@tokar.ru)</AUTHOR>" >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({{@ARGV}, '$(INST_LIB)\auto', q[$(PM_FILTER)], '$(PERM_DIR)')" -- \
	  lib/jQuery/DataTables.pm blib\lib\jQuery\DataTables.pm 
